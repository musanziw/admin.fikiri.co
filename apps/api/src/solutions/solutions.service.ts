...
export class SolutionsService {
    ...
    async findOne(id: number) {
        ...
        if (!solution) throw new HttpException("La solution n'a pas été trouvé", HttpStatus.NOT_FOUND);
        return {
            statusCode: HttpStatus.OK,
            data: solution,
        };
    ...
    async update(id: number, updateSolutionDto: UpdateSolutionDto) {
        const solution: Solution | null = await this.solutionService.findOneBy({id});
        if (!solution) throw new HttpException("L'utilisateur n'a pas été trouvé", HttpStatus.NOT_FOUND);
        ...
        try {
            ...
            throw new HttpException('Thématiques non valides', HttpStatus.BAD_REQUEST);
        }
        return {
            statusCode: HttpStatus.OK,
