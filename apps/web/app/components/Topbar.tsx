...
export default function Topbar({ background }: TopbarProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-14 z-30 w-screen ${background} transition-transform shadow-xl duration-500 right-0 lg:hidden ${
          !isOpen && "-translate-y-[200%]"
        }`}
      >
        <div
          className={
            "text-lg p-10 flex flex-col gap-4 justify-start items-start"
          }
        >
