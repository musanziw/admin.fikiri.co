...
export default function Topbar({ background }: TopbarProps) {
  ...
  const LINKS = [
    ...
    },
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
             className="bi bi-exclamation h-10 w-7 fill-gray-800"
             viewBox="0 0 16 16">
          <path
    ...
    },
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
             className="bi bi-box-arrow-in-right w-5 h-4 fill-gray-700" viewBox="0 0 16 16">
          <path fillRule="evenodd"
    ...
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-add h-4 w-5 fill-gray-700"
             viewBox="0 0 16 16">
          <path
