...
export default function Topbar({ background }: TopbarProps) {
  ...
  const LINKS = [
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-arrow-clockwise fill-gray-800 h-4 w-5" viewBox="0 0 16 16">
    ...
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" className={"bi bi-list-check fill-gray-800 h-4 w-5"} viewBox="0 0 16 16">
    ...
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-person-raised-hand fill-gray-800 h-4 w-5" viewBox="0 0 16 16">
    ...
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-box-arrow-in-right fill-gray-800 w-5 h-4" viewBox="0 0 16 16">
    ...
    {
      icon: <span>
        <svg xmlns="http://www.w3.org/2000/svg" className="bi bi-person-fill-add fill-gray-800 w-5 h-4" viewBox="0 0 16 16">
