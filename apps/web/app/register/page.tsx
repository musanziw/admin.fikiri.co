                    ...
                    <div className="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
                        ...
                        <div
                            ...
                            <div className="p-8 py-12 sm:p-16">
                                <h2 className="mb-8 text-2xl font-bold">Inscrivez-vous</h2>
                                <form action="" className="space-y-8 flex flex-col justify-center">
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-gray-800">Noms</label>
                                        <input
                                            type="text"
                                            name="email"
                                            id="email"
                                            autoComplete="email"
                                            className="focus:outline-none block w-full rounded-md border border-gray-200 px-4 py-2 transition duration-300 invalid:ring-3 ring-inset invalid:ring-red-400 focus:ring-2 focus:ring-indigo-500"
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-gray-800">Téléphone</label>
                                        <input
                                            type="text"
                                            name="email"
                                            id="email"
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-gray-800">Ville</label>
                                        <input
                                            type="text"
                                            name="email"
                                            id="email"
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-gray-800">Mot de passe</label>
                                        <input
                                            type="email"
                                            name="email"
                                            id="email"
